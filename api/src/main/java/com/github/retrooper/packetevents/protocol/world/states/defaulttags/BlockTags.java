...
public class BlockTags {
    ...
    public static final BlockTags HANGING_SIGNS = bind("ceiling_hanging_signs");
    ...
    static {
        ...
        BlockTags.ALL_HANGING_SIGNS.addTag(BlockTags.HANGING_SIGNS);
