...
public class BlockTags {
    ...
    static {
        ...
        // xiamo: Add bamboo door as wooden doors
        BlockTags.WOODEN_DOORS.add(StateTypes.BAMBOO_DOOR);
        ...
        BlockTags.LOGS_THAT_BURN.addTag(BlockTags.DARK_OAK_LOGS).addTag(BlockTags.OAK_LOGS).addTag(BlockTags.ACACIA_LOGS).addTag(BlockTags.BIRCH_LOGS).addTag(BlockTags.JUNGLE_LOGS).addTag(BlockTags.SPRUCE_LOGS).addTag(BlockTags.MANGROVE_LOGS);
        BlockTags.OVERWORLD_NATURAL_LOGS.add(StateTypes.ACACIA_LOG).add(StateTypes.BIRCH_LOG).add(StateTypes.OAK_LOG).add(StateTypes.JUNGLE_LOG).add(StateTypes.SPRUCE_LOG).add(StateTypes.DARK_OAK_LOG).add(StateTypes.MANGROVE_LOG);
        ...
        // xiamo: Custom climbable tags
        BlockTags.CLIMBABLE.add(StateTypes.BAMBOO, StateTypes.CHAIN);
        ...
        // xiamo: 1.19.4 experiemental
        BlockTags.MINEABLE_WITH_AXE.add(StateTypes.CHISELED_BOOKSHELF, StateTypes.BAMBOO_BLOCK, StateTypes.STRIPPED_BAMBOO_BLOCK);
        BlockTags.MINEABLE_WITH_PICKAXE.add(StateTypes.GLOWSTONE, StateTypes.SEA_LANTERN, StateTypes.GLOWSTONE);
        ...
        BlockTags.ALL_HANGING_SIGNS.addTag(BlockTags.CEILING_HANGING_SIGNS);
        BlockTags.ALL_HANGING_SIGNS.addTag(BlockTags.WALL_HANGING_SIGNS);

        BlockTags.MINEABLE_WITH_PICKAXE.addTag(BlockTags.GLASS_BLOCKS).addTag(BlockTags.GLASS_PANES);
    }
